          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">Modifica detaliile participantului</h5>
              </div>
              <div class="card-body">
  
<form:form action="${pageContext.request.contextPath}/editare-participanti-save.htm" method="post" modelAttribute="participantiForm">
